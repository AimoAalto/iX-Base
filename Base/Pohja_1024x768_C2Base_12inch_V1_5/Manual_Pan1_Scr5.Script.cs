...
namespace Neo.ApplicationFramework.Generated
{
    ...
    public partial class Manual_Pan1_Scr5
	{
		...
		void Manual_Pan1_Scr5_Opened(System.Object sender, System.EventArgs e)
		{
			// Initissä viedään parametrit aputoiminnoille
			kasiajot.Init(this, "Man", Globals.Tags.S7HMI_DB_ToPLC_ManualCtrl_4);

			// Luo elementeille napit
			kasiajot.LuoClickHandlerit();
		}

		void Manual_Pan1_Scr5_Closed(System.Object sender, System.EventArgs e)
		{
			// Poista napit
			kasiajot.RemoveClickHandlers();

			// Poista manuaalitilan valinta
			Globals.Tags.S7HMI_DB_ToPLC_AutoAreaCMD_ManModeSelection_4.ResetTag();
		}
    }
}
