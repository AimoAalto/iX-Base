namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class Popup_Stop_Production
	{
		...
		{
			int tulorata = Globals.Tags.HMI_Overview_TrackSelected.Value;
		...
		{
			Globals.Tags.GetTag("Line1_PLC_Lopetusvaiheet" + Globals.Tags.HMI_Overview_TrackSelected.Value).ValueChange -= Line1_PLC_LopetusvaiheetX_ValueChange;
		}
