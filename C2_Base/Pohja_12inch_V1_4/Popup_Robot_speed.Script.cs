namespace Neo.ApplicationFramework.Generated
{
    ...
    public partial class Popup_Robot_speed
    {
		...
		{
			Globals.Robotit.robotit[Globals.Tags.HMI_RobotNo.Value].Loki.LisaaLokiin("Uudet nopeusarvot: " + tyhja_nop.Value + ", " + tyhja_kii.Value + ", " + lava_nop.Value + ", " + lava_kii.Value + ", " + pahvi_nop.Value + ", " + pahvi_kii.Value);
			Globals.Robotit.robotit[Globals.Tags.HMI_RobotNo.Value].Nopeus(
